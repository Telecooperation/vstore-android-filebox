...
public class Connectivity {
     ...
     */
    public static boolean isConnectedWifi(Context c){
        NetworkInfo info = Connectivity.getNetworkInfo(c);
     ...
     */
    public static boolean isConnectedMobile(Context c){
        NetworkInfo info = Connectivity.getNetworkInfo(c);
     ...
     */
    public static boolean isConnectedFast(Context c){
        NetworkInfo info = Connectivity.getNetworkInfo(c);
     ...
     */
    public static CellularNetwork.MobileType getMobileNetworkClass(Context c) {
        ...
        switch (networkType) {
            ...
            case TelephonyManager.NETWORK_TYPE_IDEN:
                return CellularNetwork.MobileType.NET_2G;

            case TelephonyManager.NETWORK_TYPE_UMTS:
            case TelephonyManager.NETWORK_TYPE_EVDO_0:
            case TelephonyManager.NETWORK_TYPE_EVDO_A:
                return CellularNetwork.MobileType.NET_3G;
            ...
            case TelephonyManager.NETWORK_TYPE_HSPAP:
                return CellularNetwork.MobileType.NET_3_5_G;

            case TelephonyManager.NETWORK_TYPE_LTE:
                return CellularNetwork.MobileType.NET_4G;

            default:
                return CellularNetwork.MobileType.UNKNOWN;
        }
    }
